  ...
  if (funds.length === 0) {
    return (
      <div className="text-center py-12 text-gray-500">
        ...
        <p className="text-lg font-medium">No funds tracked yet</p>
        <p className="text-sm mt-1">Search and add mutual funds to start tracking</p>
      </div>
    );
  }
